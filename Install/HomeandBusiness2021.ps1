...
$installerName = "Office_Home_Business_2021.exe"
...
if (!(Test-Path $targetFile)) {
    Write-Host "Downloading Microsoft Office 2021 Home and Business..." -ForegroundColor Cyan
...
try {
    Write-Host "`nInstalling Microsoft Office 2021 Home and Business..." -ForegroundColor Yellow
    ...
    Write-Host "`n🎉 All done! Microsoft Office 2021 Home and Business is ready to use." -ForegroundColor Green
}
catch {
