...
Start-Process "winget.exe" -ArgumentList "install --id Zoom.Zoom --source winget --exact --accept-package-agreements --accept-source-agreements --ignore-security-has" -NoNewWindow -Wait
