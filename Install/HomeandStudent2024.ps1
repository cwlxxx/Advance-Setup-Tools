...
try {
    Write-Host "Installing Microsoft Office 2024 Home and Student..." -ForegroundColor Yellow
    ...
    Write-Host "All done! Microsoft Office 2024 Home and Student is ready to use." -ForegroundColor Green
}
catch {
